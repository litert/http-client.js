 ...
 * http methods
 */
export declare type TMethod = "GET" | "POST" | "PUT" | "TRACE" | "DELETE" | "OPTIONS" | "HEAD" | "PATCH" | "COPY" | "LOCK" | "UNLOCK" | "MOVE" | "MKCOL" | "PROPFIND" | "PROPPATCH" | "REPORT" | "MKACTIVITY" | "CHECKOUT" | "MERGE" | "M-SEARCH" | "NOTIFY" | "SUBSCRIBE" | "UNSUBSCRIBE";
/**
 * support http version
 */
export declare type TVersion = 1.1 | 2;
/**
 *
 */
export declare type TOutgoingHeaders = Record<string, string | number>;
/**
 ...
 * http body type
 */
export declare type Tbody = string | Buffer | Readable | {
